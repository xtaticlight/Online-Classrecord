        ...
        <div class="form-group col-lg-4 col-md-4 col-xs-4 col-lg-pull-3 col-md-pull-3 col-xs-pull-3">
            <div class="container">
                <div class="form-group col-lg-12 col-md-12 col-xs-12" style="margin-left: -25px">
                    <span style="color:Blue;font-family:Verdana;font-size:12pt;font-weight:bold;font-style:normal;">{{ $userData['id'] }}</span>
                </div>
            ...
            <div class="form-group col-lg-12 col-md-12 col-xs-12" style="margin-left: -10px">
                <a class="text-nowrap"  href="javascript:__doPostBack('ctl00$LoginView1$lbChangePW','')">Change Setup</a> | <a  href="http://localhost/e-class-record/public/login"> Logout</a>
...
<table width="100%">
    ...
    <td valign="middle" style="text-align: center; vertical-align:middle; padding:3px">
        <img  src="./assets/img/kimting.jpg" style="height:70px;width:75px;margin-top: -4px">
    </td>
                            ...
                            <tbody><tr>
                                ...
                                <tr>
                                    <td style="width: 100px; height: 30px; text-align: center;">
                                        <span style="font-size:Larger;font-weight:normal;">{{ $userData['id'] }}</span></td>
                                    <td style="text-align: center">
                                        <span  style="font-size:Larger;font-weight:normal;">{{ $userData['name'] }}</span></td>
                                    <td style="width: 75px; text-align: center;">
                                        <span style="font-size:Larger;font-weight:normal;">{{ $userData['gender'] }}</span></td>
                                </tr>
                            </tbody></table>
                    </td>
                </tr>
                    ...
                    <td style="background-color: gainsboro" valign="bottom">
                        <table style="font-size: smaller; width: 100%; font-style: italic">
                            <tbody><tr>
                                    <td>
                                        <span>Email : </span>
                                        <span>{{ $userData['email'] }}</span></td>
                                    <td>
                                        <span>Mobile No.:</span>
                                        <span>{{ $userData['contactNumber'] }}</span></td>
                                </tr>
                            </tbody></table>
                    </td>
                </tr>
